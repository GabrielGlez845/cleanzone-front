...
export class GraficasComponent implements OnInit {
 ...
 public ng2BarChart1Labels: Label[] = ['Alberto','Jose','Alfredo','Maria','Sergio','Adrian','Eduardo','Andrea','Moises','Josue'];
 ...
 public ng2BarChart1Data: ChartDataSets[] = [
   { data: [150,110,90,115,125,160,190,140,100,110], label: 'Sales', categoryPercentage: .6, barPercentage: .3 }
 ];
